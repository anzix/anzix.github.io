...
Теперь в Windows crlf текстовых файлов я смог нормально читать и редактировать
файлы

А в nano вообще показываются одни ромбы с вопросом `���`. Я пока не мог найти
решение, да и я не заинтересован в нём.
...
Для решения необходимо просто добавить в `fileencodings=[значение кодировки]`
после utf-8 кодировку cp936, в конце не срабатывает
