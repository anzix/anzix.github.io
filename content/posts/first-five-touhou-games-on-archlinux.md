...
> **Важно**: Не запускайте `xnp2` (без 1 в конце) иначе не можете запустить ни
> одну Touhou игру (будет вылезать красный текст с надписью Stop). Отличие в
> том что `xnp21` активирует IA-32 необходимый как раз для запуска Touhou игр
...
[Скачиваем шрифт](https://mega.nz/#!mBwgDAxB!AvMsrNGlR46IqU9O8yYMuYWAaGUOlcuM3YXP-FgvRyw)
от эмуля anex86 и закидываем ~/.np2/ переименовывая его в font.tmp с заменой
...
В тулбаре **HardDisk** - **IDE0-0** - **Open..** и выбираем образ игры Touhou.
После выбора в тулбаре **Emulate** - **Reset** перезагружаем эмулятор для
загрузки образа
