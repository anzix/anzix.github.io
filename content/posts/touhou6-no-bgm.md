...
Оказывается установив игру wav файлы почему-то не присутствовали в указанной
папке игры

**Решением** было скопировать из оригинального смонтированного **.iso** файла
файл содержащий bgm композиции в установленную папку игры
