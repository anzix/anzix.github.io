...
Данное решение распространяется для всех торрент клиентов (transmission,
qbittorrent и другие)

Сделать это можно с помощью `transmission-edit` который поставляется в данном
пакете, качаем его
